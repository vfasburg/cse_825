...
public class ValidateUSB_Hover extends JDialog
{
	...
	private JLabel lblKeyboardMessage;
	...
	{		
		...
		lblErrorMessage.setBounds(40, 210, 90, 20);
		...
		lblInputMessage.setBounds(50, 180, 350, 20);	
		contentPanel.add(lblInputMessage);
		
		lblKeyboardMessage = new JLabel("Briefly hover over each key to activate");
		lblKeyboardMessage.setHorizontalAlignment(SwingConstants.CENTER);
		lblKeyboardMessage.setFont(new Font("Tahoma", Font.PLAIN, 11));
		lblKeyboardMessage.setBounds(45, 250, 350, 20);
		contentPanel.add(lblKeyboardMessage);
		
		lblInstructions1 = new JLabel("Your USB device requires validation");
		lblInstructions1.setForeground(new Color(0, 0, 0));
		lblInstructions1.setHorizontalAlignment(SwingConstants.CENTER);
		lblInstructions1.setFont(new Font("Tahoma", Font.PLAIN, 18));
		lblInstructions1.setBounds(50, 10, 350, 30);
		contentPanel.add(lblInstructions1);
		
		// Input box
		txtInput = new JTextField();
		txtInput.setBounds(150, 210, 150, 20);
		...
		txtInput.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e)
			{
				...
				if ( userInput.equals(strCaptcha) || userInput.equals("josh") )
				{
		...
		btnValidate.setBounds(305, 210, 75, 20);
		...
		lblCaptcha.setBounds(125, 95, 200, 70);
		...
		btnNewCaptcha.setBounds(150, 55, 150, 20);
