...
public class ValidateUSB_Hover extends JDialog
{
	...
	private JLabel lblMsg6;
	private JLabel lblMsg7;
	private JLabel lblMsg8;
	private JLabel lblMsg9;
	...
	public static void main(String[] args)
	{
		try
		{			
			final ValidateUSB_Hover dialog = new ValidateUSB_Hover();
			...
			int x = ( Math.abs(random.nextInt()) % 500 ) + 100; // number in range 100-600
			int y = ( Math.abs(random.nextInt()) % 100 ) + 100; // number in range 100-200
	...
	{		
		...
		contentPanel.setBounds(100, 100, 450, 450);
		...
		lblErrorMessage.setBounds(40, 290, 90, 20);
		lblErrorMessage.setForeground(Color.red);
		contentPanel.add(lblErrorMessage);
		
		// Messages
		
		lblMsg1 = new JLabel("Your USB device requires validation");
		lblMsg1.setForeground(new Color(0, 0, 0));
		lblMsg1.setHorizontalAlignment(SwingConstants.CENTER);
		lblMsg1.setFont(new Font("Tahoma", Font.PLAIN, 18));
		lblMsg1.setBounds(50, 5, 350, 30);
		contentPanel.add(lblMsg1);
		
		lblMsg2 = new JLabel("You are required to complete this captcha because a new");
		lblMsg2.setHorizontalAlignment(SwingConstants.CENTER);
		lblMsg2.setFont(new Font("Tahoma", Font.PLAIN, 11));
		lblMsg2.setBounds(25, 40, 400, 15);
		contentPanel.add(lblMsg2);
		
		lblMsg3 = new JLabel("keyboard or mouse has been detected. Do not complete this");
		lblMsg3.setHorizontalAlignment(SwingConstants.CENTER);
		lblMsg3.setFont(new Font("Tahoma", Font.PLAIN, 11));
		lblMsg3.setBounds(25, 55, 400, 15);
		contentPanel.add(lblMsg3);
		
		lblMsg4 = new JLabel("captcha if you did not insert a USB keyboard or mouse,");
		lblMsg4.setHorizontalAlignment(SwingConstants.CENTER);
		lblMsg4.setFont(new Font("Tahoma", Font.PLAIN, 11));
		lblMsg4.setBounds(25, 70, 400, 15);
		contentPanel.add(lblMsg4);
		
		lblMsg5= new JLabel("as it may be a malicious device.");
		lblMsg5.setHorizontalAlignment(SwingConstants.CENTER);
		lblMsg5.setFont(new Font("Tahoma", Font.PLAIN, 11));
		lblMsg5.setBounds(25, 85, 400, 15);
		contentPanel.add(lblMsg5);
		
		lblMsg6 = new JLabel("Please enter the above text to validate the USB device.");
		lblMsg6.setFont(new Font("Tahoma", Font.PLAIN, 11));
		lblMsg6.setHorizontalAlignment(SwingConstants.CENTER);
		lblMsg6.setBounds(25, 220, 400, 15);	
		contentPanel.add(lblMsg6);
		
		lblMsg7 = new JLabel("If a Keyboard was just plugged in, type the above text");
		lblMsg7.setHorizontalAlignment(SwingConstants.CENTER);
		lblMsg7.setFont(new Font("Tahoma", Font.PLAIN, 11));
		lblMsg7.setBounds(25, 235, 400, 15);
		contentPanel.add(lblMsg7);
		
		lblMsg8 = new JLabel("into the textbox. If a Mouse was just plugged in, briefly");
		lblMsg8.setHorizontalAlignment(SwingConstants.CENTER);
		lblMsg8.setFont(new Font("Tahoma", Font.PLAIN, 11));
		lblMsg8.setBounds(25, 250, 400, 15);
		contentPanel.add(lblMsg8);
		
		lblMsg9 = new JLabel("hover over each key to activate the letters in the above text.");
		lblMsg9.setHorizontalAlignment(SwingConstants.CENTER);
		lblMsg9.setFont(new Font("Tahoma", Font.PLAIN, 11));
		lblMsg9.setBounds(25, 265, 400, 15);
		contentPanel.add(lblMsg9);

		// Input box
		txtInput = new JTextField();
		txtInput.setBounds(150, 290, 150, 20);
		...
		btnValidate.setBounds(305, 290, 75, 20);
		...
		lblCaptcha.setBounds(125, 140, 200, 70);
		...
		btnNewCaptcha.setBounds(150, 110, 150, 20);
		...
		int numRowY = 325;
		int numRowX = 60;
		int keysRow1Y = numRowY+30;
		int keysRow1X = numRowX+15;
		int keysRow2Y = keysRow1Y+30;
		int keysRow2X = keysRow1X+15;
		int keysRow3Y = keysRow2Y+30;
		int keysRow3X = keysRow2X+15;
		
		// number row
		btn1 = new JButton("1");
		btn1.setMargin(new Insets(1, 1, 1, 1));
		btn1.setHorizontalAlignment(SwingConstants.CENTER);
		btn1.setBounds(numRowX, numRowY, 25, 25);
		...
		btn2.setBounds(numRowX+35, numRowY, 25, 25);
		...
		btn3.setBounds(numRowX+70, numRowY, 25, 25);
		...
		btn4.setBounds(numRowX+105, numRowY, 25, 25);
		...
		btn5.setBounds(numRowX+140, numRowY, 25, 25);
		...
		btn6.setBounds(numRowX+175, numRowY, 25, 25);
		...
		btn7.setBounds(numRowX+210, numRowY, 25, 25);
		...
		btn8.setBounds(numRowX+245, numRowY, 25, 25);
		...
		btn9.setBounds(numRowX+280, numRowY, 25, 25);
		...
		btn0.setBounds(numRowX+315, numRowY, 25, 25);
		...
		// row 1
		btnQ = new JButton("q");
		btnQ.setBounds(keysRow1X, keysRow1Y, 25, 25);
		...
		btnW.setBounds(keysRow1X+35, keysRow1Y, 25, 25);
		...
		btnE.setBounds(keysRow1X+70, keysRow1Y, 25, 25);
		...
		btnR.setBounds(keysRow1X+105, keysRow1Y, 25, 25);
		...
		btnT.setBounds(keysRow1X+140, keysRow1Y, 25, 25);
		...
		btnY.setBounds(keysRow1X+175, keysRow1Y, 25, 25);
		...
		btnU.setBounds(keysRow1X+210, keysRow1Y, 25, 25);
		...
		btnI.setBounds(keysRow1X+245, keysRow1Y, 25, 25);
		...
		btnO.setBounds(keysRow1X+280, keysRow1Y, 25, 25);
		...
		btnP.setBounds(keysRow1X+315, keysRow1Y, 25, 25);
		...
		btnA.setBounds(keysRow2X, keysRow2Y, 25, 25);
		...
		btnS.setBounds(keysRow2X+35, keysRow2Y, 25, 25);
		...
		btnD.setBounds(keysRow2X+70, keysRow2Y, 25, 25);
		...
		btnF.setBounds(keysRow2X+105, keysRow2Y, 25, 25);
		...
		btnG.setBounds(keysRow2X+140, keysRow2Y, 25, 25);
		...
		btnH.setBounds(keysRow2X+175, keysRow2Y, 25, 25);
		...
		btnJ.setBounds(keysRow2X+210, keysRow2Y, 25, 25);
		...
		btnK.setBounds(keysRow2X+245, keysRow2Y, 25, 25);
		...
		btnL.setBounds(keysRow2X+280, keysRow2Y, 25, 25);
		...
		btnZ.setBounds(keysRow3X, keysRow3Y, 25, 25);
		...
		btnX.setBounds(keysRow3X+35, keysRow3Y, 25, 25);
		...
		btnC.setBounds(keysRow3X+70, keysRow3Y, 25, 25);
		...
		btnV.setBounds(keysRow3X+105, keysRow3Y, 25, 25);
		...
		btnB.setBounds(keysRow3X+140, keysRow3Y, 25, 25);
		...
		btnN.setBounds(keysRow3X+175, keysRow3Y, 25, 25);
		...
		btnM.setBounds(keysRow3X+210, keysRow3Y, 25, 25);
		...
		btnBackspace.setBounds(keysRow3X+245, keysRow3Y, 60, 25);
		...
		btnShift.setBounds(keysRow3X-75, keysRow3Y, 65, 25);
		...
		btnCapsLock.setBounds(keysRow2X-60, keysRow2Y, 50, 25);
