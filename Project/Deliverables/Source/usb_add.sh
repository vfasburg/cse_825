...
then
  ...
  sudo -u vince xmodmap -display :0 /usr/local/bin/Xmodmap_restricted
  # Run the human validation captcha
  sudo -u vince java -jar /usr/local/bin/ValidateUSB_Hover.jar
  ...
  sudo -u vince xmodmap -display :0 /usr/local/bin/Xmodmap_orig
